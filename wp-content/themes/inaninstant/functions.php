...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        // For item slider in themes
        wp_register_style( 'wpbs-slider', get_stylesheet_directory_uri() . '/css/owl.carousel.css', array(), '2.0', 'all' );
        wp_enqueue_style( 'wpbs-slider' );

        // For single slider in themes
        wp_register_style( 'wpbs-single-slider', get_stylesheet_directory_uri() . '/css/jquery.bxslider.css', array(), '2.0', 'all' );
        wp_enqueue_style( 'wpbs-single-slider' );	

        // For font-awesome 
        wp_register_style( 'wpbs-font-awesome', get_stylesheet_directory_uri() . '/css/font-awesome.min.css', array(), '2.0', 'all' );
        wp_enqueue_style( 'wpbs-font-awesome' );	
		
		// For font-awesome 
        wp_register_style( 'wpbs-fonts', get_stylesheet_directory_uri() . '/fonts/stylesheet.css', array(), '2.0', 'all' );
        wp_enqueue_style( 'wpbs-fonts' );	
    }
}
